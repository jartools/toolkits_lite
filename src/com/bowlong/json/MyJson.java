...
import com.bowlong.util.Base64;
...
public class MyJson {
	...
	public static final String toJSONStringNotExcept(Object v) {
		try {
	...
	public static final byte[] toBIO2(String s) throws Exception {
		...
		try (ByteOutStream os = ByteOutPool.borrowObject();) {
	...
	public static final String parseFromBIO2(byte[] b) throws Exception {
		try (ByteInStream is = ByteInPool.borrowObject(b);) {
