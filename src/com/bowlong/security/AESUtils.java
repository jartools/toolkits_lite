...
public class AESUtils {
	...
	private static final Log logger = ExToolkit.getLog(AESUtils.class);
	...
	public static void main(String[] args) {
		...
		System.out.println(String.format("加密之前：{%s}", s));
		System.out.println(String.format("加密结果：{%s}", encoded));
		System.out.println(String.format("解密结果：{%s}", decrypt(encoded, pass)));
	}
}