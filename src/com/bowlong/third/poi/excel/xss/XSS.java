...
public class XSS extends PoiEx {
	...
	public static final XSSFWorkbook openWorkbook(String fn) throws Exception {
		final InputStream inStream = FileEx.openFileInps(fn);
		return openWorkbook(inStream);
	}

	public static final XSSFWorkbook openWorkbook(InputStream inStream) throws Exception {
		OPCPackage pkg = openPackage(inStream);
		XSSFWorkbook wb = new XSSFWorkbook(pkg);
		return wb;
	}

	public static final XSSFWorkbook openWorkbook(OPCPackage pkg) throws IOException, InvalidFormatException {
		XSSFWorkbook wb = new XSSFWorkbook(pkg);
		return wb;
	}

	public static final int sheetNum(XSSFWorkbook wb) {
		return wb.getNumberOfSheets();
	}

	public static final XSSFSheet getSheet(XSSFWorkbook wb,String name) {
		XSSFSheet sheet = wb.getSheet(name);
		return sheet;
	}

	public static final Map<String, XSSFSheet> getSheetMaps(XSSFWorkbook wb) {
	...
	public static final XSSFSheet[] sheets(XSSFWorkbook wb) {
	...
	public static final int estimateSize(XSSFSheet sheet) {
		int r2 = 8;
	...
	public static final List<Map<String, String>> readHeaders(XSSFSheet sheet) {
	...
	public static final int nameCol(XSSFSheet sheet,String name) {
		for (int i = 0; i < 255; i++) {
	...
	public static final String getName(XSSFSheet sheet,int col) {
		String sName = getString(sheet, LINE_NAME, col);
		return sName;
	}

	public static final List<String> getNames(XSSFSheet sheet) {
	...
	public static final String getType(XSSFSheet sheet, int col) {
		String sName = getString(sheet, LINE_TYPE, col);
		return sName.toLowerCase();
	}

	public static final String getType(XSSFSheet sheet,String name) {
	...
	public static final String getCName(XSSFSheet sheet, int col) {
		String sName = getString(sheet, LINE_CNAME, col);
		return sName;
	}

	public static final String getCName(XSSFSheet sheet,String name) {
		int col = nameCol(sheet, name);
		if (col < 0)
			return "";
	...
	public static final String getMemo(XSSFSheet sheet, int col) {
		String sName = getString(sheet, LINE_MEMO, col);
		return sName;
	}

	public static final String getMemo(XSSFSheet sheet,String name) {
		int col = nameCol(sheet, name);
		if (col < 0)
			return "";
	...
	public static final List<String> readIndexs(XSSFSheet sheet) {
	...
	public static final String[][] readAll2D(XSSFSheet sheet) throws Exception {
	...
	public static final String[] readRow(XSSFSheet sheet,int row) throws Exception {
	...
	public static final List<List<Map<String, Object>>> readData(XSSFSheet sheet,List<Map<String, String>> headers) throws Exception {
	...
	public static final List<Map<String, Object>> readRow(XSSFSheet sheet,List<Map<String, String>> headers,int row) throws Exception {
		int column = 0;
	...
	public static final Object getObject(XSSFSheet sheet,String type,int row,int column) {
	...
	public static final String getString(XSSFSheet sheet,int row,int column) {
		try {
	...
	public static final String getComment(XSSFSheet sheet,int row,int column) {
		try {
			XSSFRow c = sheet.getRow(row);
			if (c == null)
				return "";
	...
	public static long getLong(XSSFSheet sheet,int row,int column) {
		try {
			double v = getDouble(sheet, row, column);
			return (long) v;
		} catch (Exception e) {
