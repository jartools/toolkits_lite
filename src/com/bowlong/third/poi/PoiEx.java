...
public class PoiEx {
	...
	// ==== 2003 excel
	static public final POIFSFileSystem openFS(InputStream inStream) throws Exception {
		return new POIFSFileSystem(inStream);
	}

	// ==== 2007 excel
	static public final OPCPackage openPackage(File file) throws Exception {
		return OPCPackage.open(file);
	}

	static public final OPCPackage openPackage(InputStream inStream) throws Exception {
