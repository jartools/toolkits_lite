...
public class BIO2OutputStream {
	...
	public BIO2OutputStream(final OutputStream out) {
		this.output = out;
	}

	private void _writeByte(int v) throws IOException {
		this.output.write(v);
		writePtr++;
	}
	...
	protected final void printString2(byte[] v) throws IOException {
	...
	// protected static final void printString(String v)
	// throws IOException {
	// printString(v, 0, v.length());
	// }
	//
	// protected static final void printString(String v, int
	// offset,
	...
	// _writeByte(ch);
	// else if (ch < 0x800) {
	// _writeByte(0xc0 + ((ch >> 6) & 0x1f));
	// _writeByte(0x80 + (ch & 0x3f));
	// } else {
	// _writeByte(0xe0 + ((ch >> 12) & 0xf));
	// _writeByte(0x80 + ((ch >> 6) & 0x3f));
	// _writeByte(0x80 + (ch & 0x3f));
	// }
	// }
	// }
