...
// 对比了 readMap(new ByteArrayInputStream(byte[] buf)) 和 readMap(byte[] buff) 
// 两者在性能上没什么差异。
...
public class B2InputStream {
	...
	// public static final int readByte(InputStream is) throws IOException {
	// return is.read();
	// }

	public static final int readInt(InputStream is) throws IOException {
		byte tag = _readByte(is);
		switch (tag) {
		case B2Type.INT_N1:
			return -1;
		case B2Type.INT_0:
		...
		case B2Type.INT_32:
			return 32;
		case B2Type.INT_8B: {
			byte v = (byte) _readByte(is);
			return v;
		}
		case B2Type.INT_16B: {
			short v = (short) (((_readByte(is) & 0xff) << 8) + ((_readByte(is) & 0xff) << 0));
			return v;
		}
		case B2Type.INT_32B: {
			int value1 = _readByte(is);
			int value2 = _readByte(is);
	...
	public static final NewMap readMap(InputStream is) throws Exception {
		return (NewMap) readObject(is);
	}
	...
	public static final InputStream dropBomByInps(InputStream in)
		...
		if (ch != 0xEF) {
			backInps.unread(ch);
		} else if ((ch = backInps.read()) != 0xBB) {
			backInps.unread(ch);
			backInps.unread(0xef);
		} else if ((ch = backInps.read()) != 0xBF) {
	...
	public static final String readStrByBuffReader(BufferedReader buffRead) {
		...
		try {
			String v = null;
			while ((v = buffRead.readLine()) != null) {
	...
	public static final String readStrByReader(Reader reader) {
		StringBuffer buff = StringBufPool.borrowObject();
		try {
	...
	public static final Object readObject(InputStream is) throws Exception {
		byte tag = (byte) _readByte(is);
		switch (tag) {
		case B2Type.NULL: {
			return null;
		}
		...
		case B2Type.LONG_16B: {
			int v = (((_readByte(is) & 0xff) << 8) + ((_readByte(is) & 0xff) << 0));
			return new Long(v);
		}
	...
	public final static byte[] _readBytes(byte[] in, Ref<Integer> rv, int len)
		...
		byte[] r2 = Arrays.copyOfRange(in, rv.val, rv.val + len);
		rv.val += len;
		return r2;
	}
	...
	public static final int readInt(byte[] in, Ref<Integer> rv)
		...
		case B2Type.INT_32B: {
			int value1 = _readByte(in, rv);
			int value2 = _readByte(in, rv);
	...
	public static final Object readObject(byte[] in, Ref<Integer> rv)
		...
		case B2Type.HASHTABLE_1: {
			return readMap(in, rv, 1);
		}
		case B2Type.HASHTABLE_2: {
			return readMap(in, rv, 2);
		}
		case B2Type.HASHTABLE_3: {
			return readMap(in, rv, 3);
		}
		case B2Type.HASHTABLE_4: {
			return readMap(in, rv, 4);
		}
		case B2Type.HASHTABLE_5: {
			return readMap(in, rv, 5);
		}
		case B2Type.HASHTABLE_6: {
			return readMap(in, rv, 6);
		}
		case B2Type.HASHTABLE_7: {
			return readMap(in, rv, 7);
		}
		case B2Type.HASHTABLE_8: {
			return readMap(in, rv, 8);
		}
		case B2Type.HASHTABLE_9: {
			return readMap(in, rv, 9);
		}
		case B2Type.HASHTABLE_10: {
			return readMap(in, rv, 10);
		}
		case B2Type.HASHTABLE_11: {
			return readMap(in, rv, 11);
		}
		case B2Type.HASHTABLE_12: {
			return readMap(in, rv, 12);
		}
		case B2Type.HASHTABLE_13: {
			return readMap(in, rv, 13);
		}
		case B2Type.HASHTABLE_14: {
			return readMap(in, rv, 14);
		}
		case B2Type.HASHTABLE_15: {
			return readMap(in, rv, 15);
		}
		case B2Type.HASHTABLE: {
			int len = readInt(in, rv);
			return readMap(in, rv, len);
		}
		case B2Type.INT_N1: {
			return new Integer(-1);
		}
		...
		case B2Type.STR_1: {
			return readStringImpl(in, rv, 1);
		}
		case B2Type.STR_2: {
			return readStringImpl(in, rv, 2);
		}
		case B2Type.STR_3: {
			return readStringImpl(in, rv, 3);
		}
		case B2Type.STR_4: {
			return readStringImpl(in, rv, 4);
		}
		case B2Type.STR_5: {
			return readStringImpl(in, rv, 5);
		}
		case B2Type.STR_6: {
			return readStringImpl(in, rv, 6);
		}
		case B2Type.STR_7: {
			return readStringImpl(in, rv, 7);
		}
		case B2Type.STR_8: {
			return readStringImpl(in, rv, 8);
		}
		case B2Type.STR_9: {
			return readStringImpl(in, rv, 9);
		}
		case B2Type.STR_10: {
			return readStringImpl(in, rv, 10);
		}
		case B2Type.STR_11: {
			return readStringImpl(in, rv, 11);
		}
		case B2Type.STR_12: {
			return readStringImpl(in, rv, 12);
		}
		case B2Type.STR_13: {
			return readStringImpl(in, rv, 13);
		}
		case B2Type.STR_14: {
			return readStringImpl(in, rv, 14);
		}
		case B2Type.STR_15: {
			return readStringImpl(in, rv, 15);
		}
		case B2Type.STR_16: {
			return readStringImpl(in, rv, 16);
		}
		case B2Type.STR_17: {
			return readStringImpl(in, rv, 17);
		}
		case B2Type.STR_18: {
			return readStringImpl(in, rv, 18);
		}
		case B2Type.STR_19: {
			return readStringImpl(in, rv, 19);
		}
		case B2Type.STR_20: {
			return readStringImpl(in, rv, 20);
		}
		case B2Type.STR_21: {
			return readStringImpl(in, rv, 21);
		}
		case B2Type.STR_22: {
			return readStringImpl(in, rv, 22);
		}
		case B2Type.STR_23: {
			return readStringImpl(in, rv, 23);
		}
		case B2Type.STR_24: {
			return readStringImpl(in, rv, 24);
		}
		case B2Type.STR_25: {
			return readStringImpl(in, rv, 25);
		}
		case B2Type.STR_26: {
			return readStringImpl(in, rv, 26);
		}
		case B2Type.STR: {
			int len = readInt(in, rv);
			return readStringImpl(in, rv, len);
		}
		case B2Type.BOOLEAN_TRUE: {
			return new Boolean(true);
		}
		...
		case B2Type.VECTOR_1: {
			return readList(in, rv, 1);
		}
		case B2Type.VECTOR_2: {
			return readList(in, rv, 2);
		}
		case B2Type.VECTOR_3: {
			return readList(in, rv, 3);
		}
		case B2Type.VECTOR_4: {
			return readList(in, rv, 4);
		}
		case B2Type.VECTOR_5: {
			return readList(in, rv, 5);
		}
		case B2Type.VECTOR_6: {
			return readList(in, rv, 6);
		}
		case B2Type.VECTOR_7: {
			return readList(in, rv, 7);
		}
		case B2Type.VECTOR_8: {
			return readList(in, rv, 8);
		}
		case B2Type.VECTOR_9: {
			return readList(in, rv, 9);
		}
		case B2Type.VECTOR_10: {
			return readList(in, rv, 10);
		}
		case B2Type.VECTOR_11: {
			return readList(in, rv, 11);
		}
		case B2Type.VECTOR_12: {
			return readList(in, rv, 12);
		}
		case B2Type.VECTOR_13: {
			return readList(in, rv, 13);
		}
		case B2Type.VECTOR_14: {
			return readList(in, rv, 14);
		}
		case B2Type.VECTOR_15: {
			return readList(in, rv, 15);
		}
		case B2Type.VECTOR_16: {
			return readList(in, rv, 16);
		}
		case B2Type.VECTOR_17: {
			return readList(in, rv, 17);
		}
		case B2Type.VECTOR_18: {
			return readList(in, rv, 18);
		}
		case B2Type.VECTOR_19: {
			return readList(in, rv, 19);
		}
		case B2Type.VECTOR_20: {
			return readList(in, rv, 20);
		}
		case B2Type.VECTOR_21: {
			return readList(in, rv, 21);
		}
		case B2Type.VECTOR_22: {
			return readList(in, rv, 22);
		}
		case B2Type.VECTOR_23: {
			return readList(in, rv, 23);
		}
		case B2Type.VECTOR_24: {
			return readList(in, rv, 24);
		}
		case B2Type.VECTOR: {
			int len = readInt(in, rv);
			return readList(in, rv, len);
		}
		case B2Type.SHORT_0: {
			short v = 0;
			return new Short(v);
		...
		case B2Type.LONG_8B: {
			int v = _readByte(in, rv);
			return new Long(v);
		}
		case B2Type.LONG_16B: {
			int v = (((_readByte(in, rv) & 0xff) << 8) + ((_readByte(in, rv) & 0xff) << 0));
			return new Long(v);
		}
		case B2Type.LONG_32B: {
			int v1 = _readByte(in, rv);
		...
		case B2Type.INT_ARRAY_1: {
			return readIntArray(in, rv, 1);
		}
		case B2Type.INT_ARRAY_2: {
			return readIntArray(in, rv, 2);
		}
		case B2Type.INT_ARRAY_3: {
			return readIntArray(in, rv, 3);
		}
		case B2Type.INT_ARRAY_4: {
			return readIntArray(in, rv, 4);
		}
		case B2Type.INT_ARRAY_5: {
			return readIntArray(in, rv, 5);
		}
		case B2Type.INT_ARRAY_6: {
			return readIntArray(in, rv, 6);
		}
		case B2Type.INT_ARRAY_7: {
			return readIntArray(in, rv, 7);
		}
		case B2Type.INT_ARRAY_8: {
			return readIntArray(in, rv, 8);
		}
		case B2Type.INT_ARRAY_9: {
			return readIntArray(in, rv, 9);
		}
		case B2Type.INT_ARRAY_10: {
			return readIntArray(in, rv, 10);
		}
		case B2Type.INT_ARRAY_11: {
			return readIntArray(in, rv, 11);
		}
		case B2Type.INT_ARRAY_12: {
			return readIntArray(in, rv, 12);
		}
		case B2Type.INT_ARRAY_13: {
			return readIntArray(in, rv, 13);
		}
		case B2Type.INT_ARRAY_14: {
			return readIntArray(in, rv, 14);
		}
		case B2Type.INT_ARRAY_15: {
			return readIntArray(in, rv, 15);
		}
		case B2Type.INT_ARRAY_16: {
			return readIntArray(in, rv, 16);
		}
		case B2Type.INT_ARRAY: {
			int len = readInt(in, rv);
			return readIntArray(in, rv, len);
		}
		case B2Type.INT_2D_ARRAY_0: {
			return new int[0][0];
		}
		case B2Type.INT_2D_ARRAY: {
			int len = readInt(in, rv);
			return readInt2DArray(in, rv, len);
		}
		case B2Type.Type_INT_B2: {
			return readInt(in, rv);
		}
		default:
			if (tag == -1)
				throw new SocketException("remote close.");
	...
	protected static final String readStringImpl(byte[] in, Ref<Integer> rv,
		...
		byte[] b = _readBytes(in, rv, length);
		return new String(b, B2Type.UTF8);
	}
